...
class ngs_spot_functor extends ngs_functor
{

	public ngs_spot_functor( final String src, EnumSet< ngs_field > fields )
	{
		super( src, fields );
	}
		...
		try
		{
			...
			while ( iter.nextRead() )
			{
				...
				for ( ngs_field f : fields )
				{
					switch( f )
					{
						case ID				: obj[ id++ ] = iter.getReadId(); break;
						case NFRAGMENTS		: obj[ id++ ] = iter.getNumFragments(); break;
						...
						case BASES			: obj[ id++ ] = iter.getReadBases(); break;
						case QUALITIES		: obj[ id++ ] = iter.getReadQualities(); break;
