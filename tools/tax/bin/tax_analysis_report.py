...
def main():
    ...
    formatting.add_argument('--indent', help='indentation string, default is two spaces', default='  ')
    formatting.add_argument('--separator', help='name/stats separator string, default is four spaces', default='    ')
    ...
    filtering.add_argument('--cutoff-percent', help='cutoff percent, default is %(default)s', default='0.01', type=float)
    filtering.add_argument('--cutoff-hit-count', help='cutoff hit count, disabled by default', default='0', type=int)
