...
if (NOT EXISTS ${NGS_ROOT})
    if (WIN32)
        ExternalProject_Add ( ngs 
            ...
            UPDATE_COMMAND ""
            CONFIGURE_COMMAND ""
            BUILD_COMMAND msbuild ${MSBUILD_OPTIONS} ${NGS_ROOT}/ngs-sdk/win/${NGS_VSPROJ_SUBDIR}/ngs-sdk.sln /p:NGS_OUTDIR=${OUTDIR}/ngs-sdk/ /p:Configuration=Debug
                  COMMAND msbuild ${MSBUILD_OPTIONS} ${NGS_ROOT}/ngs-sdk/win/${NGS_VSPROJ_SUBDIR}/ngs-sdk.sln /p:NGS_OUTDIR=${OUTDIR}/ngs-sdk/ /p:Configuration=Release 
